...
<body>
    ...
    <template id="task-template">
        <div id="task" class="display">
            <div id="task-status-btns" class="mobile-only">
                    <li id="task-active-mobile" class="main-btn mobile-only" aria-label="Toggle active task" titlekey="activeTaskBtn" title="Toggle active task">
                    ...
                    <li id="task-important-mobile" class="main-btn mobile-only" aria-label="Toggle important task" titlekey="importantTaskBtn" title="Toggle important task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li id="task-completed-mobile" class="main-btn mobile-only" aria-label="Toggle completed task" titlekey="completedTaskBtn" title="Toggle completed task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
            ...
            <form action="#" id="form">
                <textarea id="title" type="text" name="title" value="" phkey="untitledTask" placeholder="Untitled task" aria-label="Introduce el título de la tarea"></textarea>
                <div class="date-box">
                    <span txtkey="dateLimit">Deadline: </span>
                    <div class="date-picker">
                        <div id="date-picker-text" txtkey="noDate">Undated</div>
                        <input id="date" type="date" name="date" value="" aria-label="Introduce la fecha límite de la tarea">
                    </div>
                </div>
                <textarea id="description" type="text" name="description" phkey="taskDescription" placeholder="Task description" aria-label="Introduce la descripción de la tarea"></textarea>
            </form>
        </div>
    </template>
    ...
    <template id="without-tasks-template">
        <div id="without-tasks" class="display">
            ...
            <div class="new-task-btn btn" aria-label="Crear nueva tarea">
                ...
                <span class="btn-txt" txtkey="newTask">New task</span>
            </div>
        </div>
    </template>
        ...
        <div id="sidebar">
            <div class="header">
                <ul>
                    ...
                    <li id="list-new" class="list-btn" aria-label="Create new task" titlekey="newTaskBtn" title="Create new task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M100,15a85,85,0,1,0,85,85A84.93,84.93,0,0,0,100,15Zm0,150a65,65,0,1,1,65-65A64.87,64.87,0,0,1,100,165Zm30-72.5H110v-20a10,10,0,0,0-20,0v20H70a10,10,0,0,0,0,20H90v20a10,10,0,0,0,20,0v-20h20a10,10,0,0,0,0-20Z"/>
                        </svg>
                    </li>
                    <li id="list-delete-bulk" class="list-btn" aria-label="Delete selected tasks" titlekey="deleteTasksBtn" title="Delete selected tasks">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M100,15a85,85,0,1,0,85,85A84.93,84.93,0,0,0,100,15Zm0,150a65,65,0,1,1,65-65A64.87,64.87,0,0,1,100,165Z"/>
        ...
        <div id="main">
            <div class="header">
                <ul>
                    ...
                    <li id="task-new" class="mobile-only main-btn" aria-label="New task" titlekey="newTaskBtn" title="New task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M100,15a85,85,0,1,0,85,85A84.93,84.93,0,0,0,100,15Zm0,150a65,65,0,1,1,65-65A64.87,64.87,0,0,1,100,165Zm30-72.5H110v-20a10,10,0,0,0-20,0v20H70a10,10,0,0,0,0,20H90v20a10,10,0,0,0,20,0v-20h20a10,10,0,0,0,0-20Z"/>
                        </svg>
                    </li>
                    <li id="task-save" class="main-btn" aria-label="Save task" titlekey="saveTaskBtn" title="Save task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li id="task-active" class="main-btn desktop-only" aria-label="Toggle active task" titlekey="activeTaskBtn" title="Toggle active task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M156.31,43.63a9.9,9.9,0,0,0-14,14,60.1,60.1,0,1,1-85,0,9.9,9.9,0,0,0-14-14c-31,31-31,82,0,113s82,31,113,0A79.37,79.37,0,0,0,156.31,43.63Zm-56.5,66.5a10,10,0,0,0,10-10v-70a10,10,0,0,0-20,0v70A10,10,0,0,0,99.81,110.13Z"/>
                        </svg>
                    </li>
                    <li id="task-important" class="main-btn desktop-only" aria-label="Toggle important task" titlekey="importantTaskBtn" title="Toggle important task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M100,15a85,85,0,1,0,85,85A84.93,84.93,0,0,0,100,15Zm0,150a65,65,0,1,1,65-65A64.87,64.87,0,0,1,100,165Z"/>
                            <path d="M100,125a10,10,0,0,0-10,10v7.5a10,10,0,0,0,20,0V135A10,10,0,0,0,100,125Z"/>
                            <path d="M100,50A10,10,0,0,0,90,60v45a10,10,0,0,0,20,0V60A10,10,0,0,0,100,50Z"/>
                    ...
                    <li id="task-completed" class="main-btn desktop-only" aria-label="Toggle completed task" titlekey="completedTaskBtn" title="Toggle completed task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M177.6,80.43a10,10,0,1,0-19.5,4.5,60.76,60.76,0,0,1-6,44.5c-16.5,28.5-53.5,38.5-82,22-28.5-16-38.5-53-22-81.5s53.5-38.5,82-22a9.86,9.86,0,1,0,10-17c-38.5-22.5-87-9.5-109.5,29a80.19,80.19,0,1,0,147,20.5Zm-109.5,11a10.12,10.12,0,0,0-11,17l40,25a10.08,10.08,0,0,0,5.5,1.5,10.44,10.44,0,0,0,8-4l52.5-67.5c3.5-4.5,2.5-10.5-2-14s-10.5-2.5-14,2l-47,60Z"/>
                        </svg>
                    </li>
                    <li id="task-delete" class="main-btn" aria-label="Delete current task" titlekey="deleteTaskBtn" title="Delete current task">
                        <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                            <path d="M100,15a85,85,0,1,0,85,85A84.93,84.93,0,0,0,100,15Zm0,150a65,65,0,1,1,65-65A64.87,64.87,0,0,1,100,165Z"/>
                            <path d="M128.5,74a9.67,9.67,0,0,0-14,0L100,88.5l-14-14a9.9,9.9,0,0,0-14,14l14,14-14,14a9.9,9.9,0,0,0,14,14l14-14,14,14a9.9,9.9,0,0,0,14-14l-14-14,14-14A10.77,10.77,0,0,0,128.5,74Z"/>
                        </svg>
                    </li>
                    <li id="language" aria-label="Select language" titlekey="languageSelectBtn" title="Select language">
                        <div id="language-btn">
                            <svg data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul id="language-list" class="hidden">
                            <li class="select-lang-btn" aria-label="Select English language" titlekey="languageSelectEnBtn" title="Select English language" id="enBtn">English</li>
                            <li class="select-lang-btn" aria-label="Select Spanish language" titlekey="languageSelectEsBtn" title="Select Spanish language" id="esBtn">Español</li>
                        </ul>
                    </li>
                </ul>
            </div>          
